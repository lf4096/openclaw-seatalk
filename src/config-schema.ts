...
export const SeaTalkAccountConfigSchema = z
	.object({
		...
		dmThreadSession: z.boolean().optional(),
		groupPolicy: GroupPolicySchema.optional(),
		groupAllowFrom: z.array(z.string()).optional(),
		groupSenderAllowFrom: z.array(z.string()).optional(),
		groupThreadSession: z.boolean().optional(),
...
export const SeaTalkConfigSchema = z
	.object({
		...
		allowFrom: z.array(z.string()).optional(),
		dmThreadSession: z.boolean().optional().default(true),
		groupPolicy: GroupPolicySchema.optional().default("disabled"),
		groupAllowFrom: z.array(z.string()).optional(),
		groupSenderAllowFrom: z.array(z.string()).optional(),
		groupThreadSession: z.boolean().optional().default(true),
		threadInheritParent: z.boolean().optional().default(true),
